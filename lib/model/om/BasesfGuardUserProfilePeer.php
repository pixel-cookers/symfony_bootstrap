...
abstract class BasesfGuardUserProfilePeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Genre', 'FirstName', 'LastName', 'Culture', 'Email', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'genre', 'firstName', 'lastName', 'culture', 'email', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::GENRE, self::FIRST_NAME, self::LAST_NAME, self::CULTURE, self::EMAIL, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER_ID', 'GENRE', 'FIRST_NAME', 'LAST_NAME', 'CULTURE', 'EMAIL', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'genre', 'first_name', 'last_name', 'culture', 'email', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Genre' => 2, 'FirstName' => 3, 'LastName' => 4, 'Culture' => 5, 'Email' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'genre' => 2, 'firstName' => 3, 'lastName' => 4, 'culture' => 5, 'email' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::GENRE => 2, self::FIRST_NAME => 3, self::LAST_NAME => 4, self::CULTURE => 5, self::EMAIL => 6, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER_ID' => 1, 'GENRE' => 2, 'FIRST_NAME' => 3, 'LAST_NAME' => 4, 'CULTURE' => 5, 'EMAIL' => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'genre' => 2, 'first_name' => 3, 'last_name' => 4, 'culture' => 5, 'email' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
